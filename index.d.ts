// Type definitions for node-vault-fork 0.9
// Project: https://github.com/banno/node-vault-fork
...
declare namespace NodeVault {
    ...
    interface client {
        ...
        addKey(options?: Option): Promise<any>;
        ...
        backupKey(options?: Option): Promise<any>;
        ...
        exportKey(options?: Option): Promise<any>;
        generateDataKey(options?: Option): Promise<any>;
        generateHmac(options?: Option): Promise<any>;
        generateRandomBytes(options?: Option): Promise<any>;
        ...
        signData(options?: Option): Promise<any>;
